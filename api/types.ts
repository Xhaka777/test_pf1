...
export enum ApiRoutes {
    ...
    UPDATE_COMISSION = '/update_commission',
    UPDATE_SYMBOL_MAPPINGS = '/update_symbol_mappings',
    UPDATE_ACCOUNT_PARAMS = '/update_account_params',
    CREATE_PORTAL_SESSION = '/create-portail-session',

    //Overview
    FETCH_PROP_FIRM_OVERVIEW = '/fetch_prop_firm_overview',
    FETCH_BROKER_ACCOUNTS_OVERVIEW = '/fetch_broker_accounts_overview',
    FETCH_ACCOUNTS_OVERVIEW_DETAILS = '/fetch_accounts_overview_details',
    ...
    //Account
    ADD_ACCOUNT = '/add_account', //Kjo sna duhet ne mobike
    ...
    FETCH_PL_SL = '/fetch_pl_screenshot',
    ...
    UPLOAD_JOURNAL_SS = '/upload_journal_scrreenshot',
    ...
    GET_ANALYTICS_DETAILS = '/get_analytics_account_details',
