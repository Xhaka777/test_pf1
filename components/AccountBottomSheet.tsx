...
// ✅ FIXED: Enhanced interface for prop firm accounts
...
const AccountBottomSheet = ({ bottomSheetRef, accountData }: AccountBottomSheetProps) => {
    ...
    // ✅ FIXED: Calculate progress toward profit target for prop firm accounts
    ...
    // ✅ FIXED: Display current profit vs target
    ...
    return (
        ...
        >
            <BottomSheetView className="px-4 py-4">
                ...
                <TouchableOpacity
                    onPress={() => {
                        console.log('Trade pressed for prop firm account:', accountData?.id);
                ...
                >
                    <Text className="text-primary-100 font-InterSemiBold text-lg">
                        {accountData?.type === 'Challenge' ? 'Start Challenge' : 'Trade'}
                    </Text>
                </TouchableOpacity>
